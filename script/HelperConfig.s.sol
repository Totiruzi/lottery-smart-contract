...
contract HelperConfig is Script, CodeConstant {
        ...
        returns (NetworkConfig memory)
    {
        return
            NetworkConfig({
                ...
                account: 0xEe56334d234E8F9767444E33dCC45A993769117d
            });
    }
    ...
    function getOrCreateAnvilEthConfig() public returns (NetworkConfig memory) {
        ...
        // Deploy mocks ...
        vm.startBroadcast();
        VRFCoordinatorV2_5Mock vrfCordinatorV2Mock = new VRFCoordinatorV2_5Mock(
            MOCK_BASE_FEE,
            MOCK_GAS_PRICE,
        ...
        localNetworkConfig = NetworkConfig({
            entranceFee: 0.01 ether, // 1e16
            interval: 30,
            vrfCoordinator: address(vrfCordinatorV2Mock),
            // does not matter for the mocks
            gasLane: 0x787d74caea10b2b357790d5b5247c2f63d1d91572a9846f780606e4d953677ae,
            subscriptionId: 0,
